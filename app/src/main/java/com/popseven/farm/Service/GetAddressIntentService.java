package com.popseven.farm.Service;
...
public class GetAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (location == null) {
            ...
            sendResultsToReceiver(0, msg,msg);
            return;
        }
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            sendResultsToReceiver(1, msg,msg);
        } else {
            Address address = addresses.get(0);
            String addressDetails = new String();
            String addressDetails2 = new String();
            ...
            addressDetails=address.getSubAdminArea();

            addressDetails2=address.getAdminArea();
